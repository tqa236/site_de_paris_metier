	...
	public static void testCrediterDebiterJoueur () {
		...
		try {
         ...
         // credite incorrecte de joueurs
			...
			try {
				siteDeParisMetier.crediterJoueur("Durana", "Robertoa", "worldChampa", 10, "abef");
			...
			try {
				siteDeParisMetier.crediterJoueur("Duranb", "Robertob", "worldChampb",10, "onSaitJamais");
 			...
 			try {
				siteDeParisMetier.crediterJoueur("Maradonab", "Diegob", "world3Champ",10, null);
			...
			try {
				siteDeParisMetier.crediterJoueur(new String("Duran"), new String(" "), "world4Champ",10, new String("ilesCaimans"));
			...
			try {
				siteDeParisMetier.crediterJoueur(new String("Nobel"), new String("Alfred"), new String("tnt"),10, new String("ilesCaimans"));
      ...
      // debite incorrecte de joueurs
			...
			try {
				siteDeParisMetier.debiterJoueur("Durana", "Robertoa", "worldChampa", 10, "abef");
			...
			try {
				siteDeParisMetier.debiterJoueur(new String("Duran"), new String(" "), "world4Champ",10, new String("ilesCaimans"));
			...
			try {
				siteDeParisMetier.debiterJoueur(new String("Nobel"), new String("Alfred"), new String("tnt"),10, new String("ilesCaimans"));
			...
			try {
				siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"),-10, new String("ilesCaimans"));
	...
	public static void testMiserVainqueur () {
		...
		try {
         ...
         // parier incorrectement sur un vainqueur
			...
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String("aaaaaqqqqq"), 40, new String("ChampionnatDeFrance2012"), new String("Lyon"));
	   ...
	   *si <code>competition</code> ou <code>vainqueurEnvisage</code> sont invalides,*/
         ...
         // miser sur un vainqueur qui n'est pas dans la liste de competiteurs
         ...
         /**
         // la competition n'est plus ouverte
	...
	public static void testSolderVainqueur () {
		...
		try {
			...
			try {
				...
				System.out.println("une compétition avec un vainqueur inexistant a été soldée sans lever CompetitionException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("une compétition inexistante est  soldée sans lever CompetitionInexistanteException mais " + e.getClass().getName());
			}
